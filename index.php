    ...
    <div class="mt-5">
      <div class="row ms-3">
        <div class="col-md-6">
          ...
          <a
            href=""
            class="btn btn-color-theme pe-4 ps-4 pt-2 mt-3">Explore Now</a>
          <a
            href="user/login.php"
            class="btn btn-outline-theme pe-4 ps-4 pt-2 mt-3">Get Invoices
          </a>
        </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-8 mt-2">
                    ...
                    <br />
                    <small class="text-muted ms-2"><i data-feather="map-pin" width="16px"></i>Karang Klesem,
                      Purwokerto</small>
                  </div>
                </div>
    ...
    <div class="container">
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingNol">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseNol" aria-expanded="false" aria-controls="flush-collapseTwo">
                  <p>
                    Berapa harga potongan rambut di ADA Barbershop Karang Klesem Purwokerto?
                  </p>
                </button>
              </h2>
            ...
            <div class="accordion-item">
              ...
              <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">ADA Barbershop Karang Klesem Purwokerto cenderung melakukan hal itu, jadi jika rambut Anda telah selesai anda tidak langsung pulang.</div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">Tentu saja ADA Barbershop Karang Klesem Purwokerto bisa melihat riwayat pembayaran dengan cara login terlebih dahulu ke Get invoices</div>
              </div>
            </div>
            <div class="accordion-item">
      ...
      ?>
        <div class="row mt-5">
          ...
          <hr>
          <div class="map-content-9 mt-lg-0 mt-4">
            <p class="text-muted">Jl.Prof. M. Yamin, Karangklesem, Karangpucung,
              Kec. Purwokerto Selatan, Kab. Banyumas 53144
              . </p>
          </div>
          </div>
        </div>
